  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={
          "bg-background pointer-events-none block size-3.5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%+2px)] data-[state=unchecked]:translate-x-0.5 shadow-sm"
        }
      />
    </SwitchPrimitive.Root>
  )
